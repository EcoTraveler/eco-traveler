...
const destinationsData: Destination[] = [
  ...
  },
  {
    ...
    destination: {
      ...
      imgUrl:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Jam_Gadang_memanjang.jpg/1200px-Jam_Gadang_memanjang.jpg",
      longDescription:
  ...
  },
  {
    ...
    destination: {
      ...
      imgUrl:
        "https://upload.wikimedia.org/wikipedia/commons/1/18/Istana_Kerajaan_Siak_%283%29.jpg",
      longDescription:
  ...
  },
  {
    ...
    destination: {
      name: "Pantai Trikora",
      description:
        "Pantai cantik di Pulau Bintan dengan pasir putih dan air jernih.",
      imgUrl:
        "https://atourin.obs.ap-southeast-3.myhuaweicloud.com/images/destination/bintan/pantai-trikora-profile1695024664.jpeg?x-image-process=image/resize,p_100,limit_1/imageslim",
      longDescription:
  ...
  },
  {
    ...
    destination: {
      ...
      imgUrl:
        "https://upload.wikimedia.org/wikipedia/commons/f/f4/Uprising-mount_kerinci.jpg",
      longDescription:
  ...
  },
  {
    ...
    destination: {
      ...
      imgUrl:
        "https://wonderfulimage.s3-id-jkt-1.kilatstorage.id/1701852720-42dc2d82-a28e-4c71-9031-24f601893bf1-40730-0000049d09df54ae-jpg-medium.jpg",
      longDescription:
  ...
  },
  {
    ...
    destination: {
      ...
      imgUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgmThHexRpwT1D5bi4ho7rGmkYqr8QTlwnrA&s",
      longDescription:
      ...
      attractions: [
        ...
        "Taman di Sekitar Benteng",
        "Pemandangan ke Laut Bengkulu",
      ],
  ...
  },
  {
    ...
    destination: {
      ...
      imgUrl:
        "https://asset.kompas.com/crops/Zth1oN7cO0wTZGrIPSnoAymoiUE=/0x0:0x0/1200x800/data/photo/2021/01/05/5ff421715559d.jpeg",
      longDescription:
        "Taman Nasional Way Kambas adalah cagar alam yang terkenal sebagai habitat gajah Sumatera. Di sini, pengunjung dapat melihat konservasi dan pelatihan gajah serta menikmati lingkungan alam yang asri.",
  ...
  },
  {
    ...
    destination: {
      ...
      imgUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0Lq9yc4mMTPWx9EmXauc28cSxcHcZnSViNQ&s",
      longDescription:
  ...
  },
  {
    ...
    destination: {
      ...
      imgUrl:
        "https://web.visitkotawaringinbarat.id/wp-content/uploads/2021/01/Kelotok_Wisata.jpg",
      longDescription:
  ...
  },
  {
    ...
    destination: {
      ...
      imgUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSlJZmf7nL-BsgxgOxhtTayZKaHcCuDD5iKzA&s",
      longDescription:
      ...
      attractions: [
        "Belanja di Atas Perahu",
        "Wisata Kuliner Tradisional",
        "Fotografi Pasar Terapung",
      ],
  ...
  },
  {
    ...
    destination: {
      ...
      description:
        "Taman nasional yang melestarikan hutan hujan tropis Kalimantan.",
      imgUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9QMjE1xh177XwffcAPNrcLbA5Ut_Sroop5Q&s",
      longDescription:
  ...
  },
  {
    ...
    destination: {
      name: "Pantai Anyer",
      description:
        "Pantai populer dekat Jakarta dengan pemandangan indah ke Gunung Krakatau.",
      imgUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTi7YB1uXm9NX3bMyqtBu1gi1M-EGdyEUFndg&s",
      longDescription:
  ...
  },
  {
    ...
    destination: {
      name: "Kawah Putih",
      description:
        "Danau kawah dengan air berwarna putih kehijauan di Ciwidey.",
      imgUrl:
        "https://dirgantaracarrental.com/wp-content/uploads/2017/01/Paket-Wisata-Kawah-Putih-Ciwidey1.jpg",
      longDescription:
  ...
  },
  {
    ...
    destination: {
      ...
      description:
        "Candi Buddha terbesar di dunia yang termasuk situs Warisan Dunia UNESCO.",
      imgUrl:
        "https://www.indonesia.travel/content/dam/indtravelrevamp/en/destinations/revision-2019/4.jpg",
      longDescription:
        "Candi Borobudur adalah candi Buddha terbesar di dunia, terletak di Magelang, Jawa Tengah. Candi ini dihiasi dengan relief yang menceritakan kehidupan Buddha dan dianggap sebagai karya arsitektur yang megah.",
      attractions: [
        "Ziarah Budaya",
        "Fotografi Relief",
        "Trekking ke Bukit Menoreh",
      ],
      bestTimeToVisit: "April hingga Oktober",
    },
  },
  {
    ...
    destination: {
      name: "Pulau Pahawang",
      description:
        "Pulau yang terkenal dengan keindahan bawah lautnya di Lampung.",
      imgUrl:
        "https://res.cloudinary.com/dqczvxzoq/image/upload/v1730877819/pahawang-lampung_bkqlg7.webp",
      longDescription:
  ...
  },
  {
    ...
    destination: {
      ...
      description:
        "Pantai dengan pasir putih dan bebatuan granit yang eksotis.",
      imgUrl:
        "https://res.cloudinary.com/dqczvxzoq/image/upload/v1730877818/pantai-parai-tenggiri_edxuap.jpg",
      longDescription:
  ...
  },
  {
    ...
    destination: {
      name: "Tanjung Lesung",
      description:
        "Destinasi pantai eksklusif di Banten dengan pasir putih dan laut biru.",
      imgUrl:
        "https://res.cloudinary.com/dqczvxzoq/image/upload/v1730877819/tanjung-lesung_l5gybp.jpg",
      longDescription:
  ...
  },
  {
    ...
    destination: {
      ...
      description:
        "Monumen kebanggaan Indonesia yang berlokasi di pusat Jakarta.",
      imgUrl:
        "https://res.cloudinary.com/dqczvxzoq/image/upload/v1730877820/monas-dki_ivzk4p.jpg",
      longDescription:
  ...
  },
  {
    ...
    destination: {
      name: "Gunung Bromo",
      description:
        "Gunung aktif yang terkenal dengan pemandangan sunrise di Jawa Timur.",
      imgUrl:
        "https://res.cloudinary.com/dqczvxzoq/image/upload/v1730877819/gunung-bromo_vx30xa.jpg",
      longDescription:
  ...
  },
  {
    ...
    destination: {
      name: "Pura Uluwatu",
      description:
        "Pura tepi tebing di Bali yang menawarkan pemandangan matahari terbenam.",
      imgUrl:
        "https://res.cloudinary.com/dqczvxzoq/image/upload/v1730877819/pura-uluwatu-bali_xstjtx.jpg",
      longDescription:
        "Pura Uluwatu adalah pura Hindu yang terletak di atas tebing tinggi, menawarkan pemandangan Samudra Hindia yang menakjubkan. Pura ini terkenal dengan pertunjukan tari kecak saat matahari terbenam.",
  ...
  },
  {
    ...
    destination: {
      ...
      description:
        "Habitat asli komodo dan pantai berwarna merah muda yang unik.",
      imgUrl:
        "https://res.cloudinary.com/dqczvxzoq/image/upload/v1730877819/pulau-komodo_zl8wrz.jpg",
      longDescription:
        "Taman Nasional Komodo adalah rumah bagi kadal komodo yang hanya ditemukan di Indonesia. Taman ini juga memiliki pantai berpasir merah muda yang disebut Pantai Pink, serta pemandangan alam yang luar biasa.",
      attractions: [
        "Pantai Pink",
        "Pengamatan Komodo",
  ...
  },
  {
    ...
    destination: {
      name: "Raja Ampat",
      description:
        "Kepulauan yang terkenal dengan keindahan alam bawah lautnya.",
      imgUrl:
        "https://res.cloudinary.com/dqczvxzoq/image/upload/v1730877820/raja-ampat_tanj1b.jpg",
      longDescription:
        "Raja Ampat adalah surga bagi penyelam dengan terumbu karang yang kaya akan keanekaragaman hayati. Kepulauan ini memiliki pemandangan alam yang sangat memukau, baik di atas maupun di bawah laut.",
      attractions: [
        "Diving dan Snorkeling",
  ...
  },
  {
    ...
    destination: {
      ...
      attractions: [
        "Snorkeling dan Diving",
        "Resort dan Kafe Pinggir Pantai",
        "Spot Foto Alam",
      ],
  ...
  },
  {
    ...
    destination: {
      ...
      imgUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgmThHexRpwT1D5bi4ho7rGmkYqr8QTlwnrA&s",
      longDescription:
        "Benteng Marlborough adalah benteng kolonial yang dibangun oleh Inggris pada abad ke-18 di Bengkulu. Dengan arsitektur khas kolonial, benteng ini kini menjadi museum yang mengisahkan sejarah masa lalu Bengkulu.",
...
export default function DetailedDestinationPage() {
  ...
  if (!destination) return <div>Loading destination data...</div>;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <div className="relative h-96 mb-4">
              <Image
                src={destination.destination.imgUrl}
            ...
            <div className="mb-4">
              <h2 className="text-2xl font-semibold mb-2">Atraksi Utama</h2>
              <ul className="list-disc list-inside">
                {destination.destination.attractions.map(
                  (attraction, index) => (
