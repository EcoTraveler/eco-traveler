...
//             <CardHeader>
//               <CardTitle className="text-2xl font-bold text-green-500">Hello Traveler</CardTitle>
...
//                 <button className="p-2 bg-white rounded-full shadow-md hover:shadow-lg transition-shadow duration-200 hover:bg-green-100" aria-label="Login with Google">
//                   <Mail className="w-6 h-6 text-red-500" />
//                 </button>
//                 <button className="p-2 bg-white rounded-full shadow-md hover:shadow-lg transition-shadow duration-200 hover:bg-green-100" aria-label="Login with GitHub">
//                   <Github className="w-6 h-6 text-gray-800" />
//                 </button>
//                 <button className="p-2 bg-white rounded-full shadow-md hover:shadow-lg transition-shadow duration-200 hover:bg-green-100" aria-label="Login with Discord">
//                   <svg className="w-6 h-6 text-indigo-600" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="discord" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
//                     <path
//                       fill="currentColor"
      ...
      <div className="w-full max-w-5xl flex flex-col lg:flex-row items-center gap-8">
        <motion.div className="w-full md:w-1/2 max-w-md mb-8 md:mb-0 md:mr-8" initial={{ x: -50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: -50, opacity: 0 }} transition={{ type: "spring", stiffness: 100, damping: 20 }}>
          <Card className="w-full">
            ...
            {/* Additional content like "Or continue with" buttons */}
          </Card>
        </motion.div>
